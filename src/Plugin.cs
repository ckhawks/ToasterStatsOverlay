...
{
    public static string MOD_NAME = "ToasterStatsOverlay";
    public static string MOD_VERSION = "1.0.0";
    public static string MOD_GUID = "pw.stellaric.toaster.statsoverlay";

    static readonly Harmony harmony = new Harmony(MOD_GUID);
    
    public static StatsOverlay statsOverlay;
    ...
    public bool OnDisable()
    {
        try
        {
            ...
            Plugin.statsOverlay.OnDestroy();
            Plugin.statsOverlay = null;
